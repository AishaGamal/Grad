...
void getPulseOxi()
{
  ...
  bloodSugre = prepareBloodSugre (irRawValue,redRawValue);
...
void loop() {
  ...
  if (millis()- temperatureTs >= 3000)
  {
    ...
    if (temperature > 38.5)
    {
      Serial.println("Buzzer Temperature");
      buzzerTemperature();
    }
    ...
    
    {
      ...
      if (transmit == true)
      {
        ...
        else
        {
          ...
          Serial.print("Sending To Count: "); Serial.println(count);
